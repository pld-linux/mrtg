...
*/5 * * * * root umask 022; /bin/nice -n 20 %{_libdir}/mrtg/indexmaker --title 'Statistics' --prefix '.' --output /home/httpd/html/mrtg/index.html %{_sysconfdir}/mrtg/mrtg.cfg 2> /dev/null
EOF
